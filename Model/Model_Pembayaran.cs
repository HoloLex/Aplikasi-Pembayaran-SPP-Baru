...
{
    internal class Model_Pembayaran
    {
        //dont forget ctr+r+e lolz
        string id_pembayaran, id_petugas, nisn, tgl_bayar, bulan_bayar, tahun_dibayar, id_spp, jumlah_bayar;
        ...
        public string Bulan_bayar { get => bulan_bayar; set => bulan_bayar = value; }
        ...
        public Model_Pembayaran(string id_pembayaran, string id_petugas, string nisn, string tgl_bayar, string bulan_bayar, string tahun_dibayar, string id_spp, string jumlah_bayar)
        {
